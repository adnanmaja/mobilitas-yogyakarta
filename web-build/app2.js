document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add PMTiles protocol
    ...
    const map = new maplibregl.Map({
        container: 'map',
        style: `https://api.maptiler.com/maps/dataviz-dark/style.json?key=BoPQNSkj4hZi6ZH9cnjB`,
  ...
  // All layer groups
  const layerGroups = {
    residential: ['residential-layer-1km', 'residential-layer-300m'],
    employment: ['employment-layer-1km', 'employment-layer-300m'],
    amenity: ['hbnw-amenity-layer-1km', 'nhb-amenity-layer-1km', 'all-amenity-layer-1km'],
  ...
  'amenity-hbnw': 'hbnw-amenity-layer-1km',
  'amenity-nhb': 'nhb-amenity-layer-1km',
  'amenity-all': 'all-amenity-layer-1km'
};
  ...
  function createTypeDropdownPanel() {
    ...
    const types = [
      ...
      { id: 'amenity-all', label: 'All Amenities' }
    ];
  ...
  map.on('load', () => {
    // ORIGINS
    map.addSource('residential_1000', {
      type: 'geojson',
      data: '../data/raw/residential_1000m.geojson'
    });
    map.addSource('residential_300', {
      type: 'geojson',
      data: '../data/raw/origin_v2_1_300m.geojson'
    });

    map.addLayer({
      id: 'residential-layer-300m',
      type: 'circle',
      source: 'residential_300',
      minzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    map.addLayer({
      id: 'residential-layer-1km',
      type: 'circle',
      source: 'residential_1000',
      maxzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    // DESTINATIONS
    map.addSource('employment_1000', {
      type: 'geojson',
      data: '../data/raw/employment_1000m.geojson'
    });
    map.addSource('employment_300', {
      type: 'geojson',
      data: '../data/raw/destination_v3_300m.geojson'
    });

    map.addLayer({
      id: 'employment-layer-300m',
      type: 'circle',
      source: 'employment_300',
      minzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    map.addLayer({
      id: 'employment-layer-1km',
      type: 'circle',
      source: 'employment_1000',
      maxzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    // AMENITIES 
    map.addSource('hbnw_amenity_1000', {
      type: 'geojson',
      data: '../data/raw/services_amenities_1000m.geojson'
    });
    map.addSource('nhb_amenity_1000', {
      type: 'geojson',
      data: '../data/raw/services_amenities_1000m.geojson'
    });
    map.addSource('all_amenity_1000', {
      type: 'geojson',
      data: '../d ata/raw/services_amenities_1000m.geojson'
    });

    map.addLayer({
      id: 'hbnw-amenity-layer-1km',
      type: 'circle',
      source: 'hbnw_amenity_1000',
      // minzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    map.addLayer({
      id: 'nhb-amenity-layer-1km',
      type: 'circle',
      source: 'nhb_amenity_1000',
      // minzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
    ...
    map.addLayer({
      id: 'all-amenity-layer-1km',
      type: 'circle',
      source: 'all_amenity_1000',
      minzoom: 16,
      paint: {
        'circle-radius': [
          'interpolate',
          ['linear'],
          ['get', 'amenity_all_intensity'],
          0, 0,
          100, 18
        ],
        'circle-color': [
    ...
    map.addSource('peak-flow-data', {
      type: 'geojson',
      data: '../data/raw/rea_1000m_edge_flows_v3.geojson'
    });
    map.addSource('off-peak-flow-data', {
      type: 'geojson',
      data: '../data/raw/tes off_peak_routed_vectors_1000m_edge_flows.geojson'
    });
    map.addSource('weekend-flow-data', {
      type: 'geojson',
      data: '../data/raw/tes weekend_routed_vectors_1000m_edge_flows.geojson'
    });
    ...
    map.addSource('peak-congestion-data', {
      type: 'geojson',
      data: '../data/raw/rea_1000m_congestions_v4.geojson'
    });
    map.addSource('off-peak-congestion-data', {
      type: 'geojson',
      data: '../data/raw/off_peak_routed_vectors_1000m_congestions.geojson'
    });
    map.addSource('weekend-congestion-data', {
      type: 'geojson',
      data: '../data/raw/weekend_routed_vectors_1000m_congestions.geojson'
    });
